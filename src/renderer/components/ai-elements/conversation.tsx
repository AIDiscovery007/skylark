...
type ConversationViewportProps = ComponentProps<"div"> & {
	"data-slot"?: string;
...
const ConversationContentInner = ({
	...
	const { className: viewportClassName, ref: viewportRef, style, ...viewportProps } = scrollProps ?? {};
	...
	return (
		<div
			className={cn(scrollClassName, viewportClassName)}
			ref={setViewportRef}
			style={{
				height: "100%",
				width: "100%",
